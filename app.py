...
# Create Faker instance globally
fake = Faker()

# Database Configuration (Use environment variables or secure config in production)
DB_NAME = 'your_database.db'  # Replace with your actual database name
TABLE_NAME = 'rakesh'
BATCH_SIZE = 30
...
def fetch_and_create_csv(batch_size=BATCH_SIZE):
    ...
    global data_initialized  # Access the global flag
        ...
        while True:
            try:
                ...
                if not data:
                    ...
                    # Stop the schedule after processing all data
                    return
...
def run_schedule():
    ...
    while schedule.jobs:  # Keep running until all scheduled jobs are done
